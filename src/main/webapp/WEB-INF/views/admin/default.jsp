...
#responsive-admin-menu #logo {
  ...
  height: 40px;
  margin: 10px;
  background: url("https://assets.codepen.io/assets/footer/codepen-logo-midgray.svg")
    no-repeat;
...
<div id="content-wrapper">
	<div style="border:1px #e8e8e8 solid;width:100%;margin:10px 0px 10px 0px;flex-direction: row;">
		<div style="border-bottom:1px #e8e8e8 solid;background-color:#f3f3f3;padding:8px;font-size:13px;font-weight:700;color:#45484d;">
			게시글 관리</div>
			<iframe src="/admin/board" style="width: 1000px; height: 700px;" scrolling="no" frameborder="0"></iframe>

	
	<div style="border:1px #e8e8e8 solid;width:100%;margin:10px 0px 10px 0px;flex-direction: row;">
		<div style="border-bottom:1px #e8e8e8 solid;background-color:#f3f3f3;padding:8px;font-size:13px;font-weight:700;color:#45484d;">
			회원 관리</div>		
			<iframe src="/admin/member" style="width: 1000px; height: 700px;" scrolling="no" frameborder="0"></iframe>
	</div>
	</div>
