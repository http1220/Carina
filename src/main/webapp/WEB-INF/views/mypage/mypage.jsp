...
<div class="container"> 
	...
	<div class="menu">
		<ul class="menu_ul">
			<li><a href="/myimfo" style="text-decoration : none;">내 정보 수정</a></li>
			<li><a href="/favlist" style="text-decoration : none;">찜 목록</a></li>
			<li><a href="/estimate" style="text-decoration : none;">견적 신청 내역</a></li>
			<li><a href="/myproduct" style="text-decoration : none;">매물 등록 내역</a></li></li>
		</ul>
	...
	<div class="content">
		...
		<div class="board">
			...
			<p>이곳에서 사용자 개인 서비스를 이용할 수 있습니다.</p>
		</div>
		<!-- <div class="paging">
