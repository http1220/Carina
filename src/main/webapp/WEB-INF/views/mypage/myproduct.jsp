...
<script>
function delet_board(param){
	if (window.confirm("삭제하시겠습니까?")) {
		console.log(param);
		const data = {bno : param};
...
function go_board_detail(param){
	...
	.then(function(data){
		...
		const htmlcode = `
							...
							<p>등록일 : `+data.registration_date+`</p>
							<p>차량번호 : `+data.vehicle_no+`</p>
							<p>조회수 : `+data.views+`</p>							
							`;
...
<div class="container"> 
	<div class="container">
		<div class="nav">
			<span><a href="/index" style="text-decoration: none;">홈으로</a></span>

		</div>

		<div class="menu">
			<ul class="menu_ul">
				<li><a href="/myinfo" style="text-decoration: none;">내 정보
						수정</a></li>
				<li><a href="/favlist" style="text-decoration: none;">찜 목록</a></li>
				<li><a href="/estimate" style="text-decoration: none;">견적
						신청 내역</a></li>
				<li><a href="/myproduct" style="text-decoration: none;">매물
						등록 내역</a></li>
				</li>
			</ul>
			   			...
			   			<div class="table-row">
			    			...
			    			<div class="row-item" onclick="go_board_detail('${i.bno}')">${i.nickname}</div>
				      		...
				      		<div class="row-item" onclick="go_board_detail('${i.bno}')">${i.views}</div>
		       			 	<div class="row-item"><button onclick="delet_board('${i.bno}')">판매취소</button></div>
			    		</div>
			    	</c:forEach>			      
