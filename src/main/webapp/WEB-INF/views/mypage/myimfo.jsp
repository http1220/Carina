...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <dl class="op_area">
            ...
            <dd>${info.email }</dd>
            <dt>생일</dt>
            <dd><fmt:formatDate pattern="yyyy-MM-dd" value="${info.dateOfBirth }" /></dd>
            <dt>회원가입일시</dt>
            <dd><fmt:formatDate pattern="yyyy-MM-dd" value="${info.joinDate}" /></dd>
            <dt id="smb_my_ovaddt">주소</dt>
            <dd id="smb_my_ovaddd">${info.address}</dd>
        </dl>
        
        <a href="/sessionout" class="withdrawal" onclick="dd()">회원탈퇴</a>
...
<div class="content">
			<span class="title">
				<p>이곳에서 사용자 정보를 수정 할 수 있습니다.</p>
			</span>
			<div class="board">
				<form id="fregisterform" name="fregisterform" action="/updatemyinfo"
					method="post">
					<div id="register_form" class="form_01">
						<div>
							<ul>
								<li><label for="id" class="sound_only">아이디</label> <input
									type="text" id="id" name="id" value="${info.id }" required
									class="frm_input half_input required " size="10"
									placeholder="아이디" readonly="readonly"></li>
							</ul>
						</div>
						<div class="tbl_frm01 tbl_wrap">
							<ul>
								<li><label for="name" class="sound_only">이름</label> <input
									type="text" id="name" name="name" value="${info.name }" required
									class="frm_input half_input required " size="10"
									placeholder="이름" readonly="readonly"></li>
								<li><label for="nickname" class="sound_only">닉네임</label> <input
									type="hidden" name="nickname_default" value=""> <input
									type="text" name="nickname" value="${info.nickname }" id="nickname" required
									...
									<p id="checkResult2"></p> <span id="msg_nickname"></span> <span
									class="frm_info"> 공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)<br>
										닉네임을 바꾸시면 앞으로 0일 이내에는 변경 할 수 없습니다.
								</span></li>

								<li><label for="email" class="sound_only">E-mail<strong></strong></label>

									<input type="hidden" name="old_email" value=""> <input
									type="text" name="email" value="${info.email }" id="email"
									required class="frm_input email full_input required"
									style="width: 575px;" size="70" maxlength="100"
									placeholder="E-mail">
									<button type="button" class="btn_frmline" onclick="check3()">중복확인</button>
									<p id="checkResult3"></p></li>

								<li><label for="phoneNumber" class="sound_only">휴대폰번호<strong></strong></label>
									<input type="text" name="phoneNumber" value="${info.phoneNumber }"
									id="phoneNumber" required class="frm_input half_input required"
									maxlength="20" placeholder="휴대폰번호"> <input
									type="hidden" name="old_phoneNumber" value=""></li>

								<li><strong class="sound_only"></strong> <label
									for="postcode" class="sound_only">우편번호<strong
										class="sound_only"> </strong></label> <input type="text"
									name="postcode" value="${info.postcode }" id="postcode" required
									class="frm_input required" size="5" maxlength="6"
									placeholder="우편번호">
									<button type="button" class="btn_frmline"
										onclick="win_zip('fregisterform', 'postcode', 'address', 'detailAddress', 'extraAddress', 'mb_addr_jibeon');">주소
										검색</button>
									<br> <input type="text" name="address"
									value="${info.address }" id="address" required
									class="frm_input frm_address full_input required" size="50"
									placeholder="기본주소"> <label for="address"
									class="sound_only">기본주소<strong> </strong></label><br> <input
									type="text" name="extraAddress" value="${info.extraAddress }"
									id="extraAddress" class="frm_input frm_address full_input"
									size="50" readonly="readonly" placeholder="참고항목"> <label
									for="extraAddress" class="sound_only">참고항목</label> <br> <input
									type="text" name="detailAddress" value="${info.detailAddress }"
									id="detailAddress" class="frm_input frm_address full_input"
									size="50" placeholder="상세주소"> <label
									for="detailAddress" class="sound_only">상세주소</label> <input
					...
					<div class="btn_confirm">
						<input type="submit" value="수정하기" id="joinBtn" class="btn_submit">
					</div>
				</form>
			</div>
